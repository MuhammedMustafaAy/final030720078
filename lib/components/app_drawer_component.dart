...
class AppDrawerComponent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final user = supabase.auth.currentUser; // Access currentUser instead of user()
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                // Display user's email if available, otherwise fallback to "User"
                                Text(user?.email ?? 'User', style: boldTextStyle(fontSize: 16)),
